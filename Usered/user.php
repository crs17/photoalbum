<?php
	...
	// ---------------------
		...
		function register(&$registration_callback=false)
		{
			...
			$registered = $this->register_user($username, $email, $sha1, $role, $registration_callback);
...
EOT;
	...
	// ------------------
		 ...
		 */
		function register_user($username, $email, $sha1, $role, &$registration_callback = false)
		{
